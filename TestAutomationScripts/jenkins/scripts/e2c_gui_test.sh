#!/bin/sh -x
#-xe
# This thest shall be run on machine TITAN1, under linux, ubuntu 18.04
...
export ECLIPSE_DIR=/home/titanrt/github_eclipse_installed/eclipse-SDK-4.5.2-linux-gtk-x86_64
