...
import org.eclipse.titan.runtime.core.Value_Redirect_Interface;
import java.text.MessageFormat;
import java.util.ArrayList;
import java.util.LinkedList;
import org.eclipse.titan.titan_JavaTestPorts_IPL4.user_provided.IPL4asp__PT_PROVIDER;
...
public final class IPL4asp__PortType extends TTCN_Module {
	...
	public IPL4asp__PortType() {
		super("IPL4asp_PortType", module_type_enum.TTCN3_MODULE, new byte[] {(byte)204, (byte)159, (byte)202, (byte)58, (byte)111, (byte)195, (byte)23, (byte)241, (byte)77, (byte)149, (byte)222, (byte)77, (byte)140, (byte)156, (byte)192, (byte)4});
	}
	...
	public static class anytype_template extends Base_Template {
		...
		public anytype_template list_item(final int list_index)  {
			...
			if (list_index < 0) {
				throw new TtcnError(MessageFormat.format("Internal error: Accessing a value list template of type @IPL4asp_PortType.anytype using a negative index ({0}).", list_index));
...
private ArrayList<TitanPort> mapped_ports;
public IPL4asp__PT( final String port_name) {
super(port_name);
mapped_ports = new ArrayList<TitanPort>();
}
...
final TTCN_Logger.Severity log_severity = destination_component.get_component() == TitanComponent.SYSTEM_COMPREF ? TTCN_Logger.Severity.PORTEVENT_MMSEND : TTCN_Logger.Severity.PORTEVENT_MCSEND;
...
send_par.log();
TTCN_Logger.log_msgport_send(get_name(), destination_component.get_component(), TTCN_Logger.end_event_log2str());
}
...
public TitanAlt_Status receive(final IPL4asp__Types.ASP__RecvFrom_template value_template, final Value_Redirect_Interface value_redirect, final TitanComponent_template sender_template, final TitanComponent sender_pointer, final TitanFloat timestamp_redirect, final Index_Redirect index_redirect) {
...
value_redirect.set_values((IPL4asp__Types.ASP__RecvFrom) my_head.message);
}
if (sender_pointer != null) {
sender_pointer.operator_assign(my_head.sender_component);
}
...
public TitanAlt_Status check_receive(final IPL4asp__Types.ASP__RecvFrom_template value_template, final Value_Redirect_Interface value_redirect, final TitanComponent_template sender_template, final TitanComponent sender_pointer, final TitanFloat timestamp_redirect, final Index_Redirect index_redirect) {
if (value_template.get_selection() == template_sel.ANY_OR_OMIT) {
...
public TitanAlt_Status trigger(final IPL4asp__Types.ASP__RecvFrom_template value_template, final Value_Redirect_Interface value_redirect, final TitanComponent_template sender_template, final TitanComponent sender_pointer, final TitanFloat timestamp_redirect, final Index_Redirect index_redirect) {
if (value_template.get_selection() == template_sel.ANY_OR_OMIT) {
...
public TitanAlt_Status receive(final Socket__API__Definitions.PortEvent_template value_template, final Value_Redirect_Interface value_redirect, final TitanComponent_template sender_template, final TitanComponent sender_pointer, final TitanFloat timestamp_redirect, final Index_Redirect index_redirect) {
if (value_template.get_selection() == template_sel.ANY_OR_OMIT) {
throw new TtcnError("Receive operation using '*' as matching template");
}
if (message_queue.isEmpty()) {
...
if (value_redirect != null) {
value_redirect.set_values((Socket__API__Definitions.PortEvent) my_head.message);
}
if (sender_pointer != null) {
sender_pointer.operator_assign(my_head.sender_component);
}
...
public TitanAlt_Status check_receive(final Socket__API__Definitions.PortEvent_template value_template, final Value_Redirect_Interface value_redirect, final TitanComponent_template sender_template, final TitanComponent sender_pointer, final TitanFloat timestamp_redirect, final Index_Redirect index_redirect) {
if (value_template.get_selection() == template_sel.ANY_OR_OMIT) {
throw new TtcnError("Check-receive operation using '*' as matching template");
}
if (message_queue.isEmpty()) {
...
public TitanAlt_Status trigger(final Socket__API__Definitions.PortEvent_template value_template, final Value_Redirect_Interface value_redirect, final TitanComponent_template sender_template, final TitanComponent sender_pointer, final TitanFloat timestamp_redirect, final Index_Redirect index_redirect) {
if (value_template.get_selection() == template_sel.ANY_OR_OMIT) {
throw new TtcnError("Trigger operation using '*' as matching template");
}
if (message_queue.isEmpty()) {
...
public TitanAlt_Status receive(final IPL4asp__Types.ASP__ConnId__ReadyToRelease_template value_template, final Value_Redirect_Interface value_redirect, final TitanComponent_template sender_template, final TitanComponent sender_pointer, final TitanFloat timestamp_redirect, final Index_Redirect index_redirect) {
if (value_template.get_selection() == template_sel.ANY_OR_OMIT) {
throw new TtcnError("Receive operation using '*' as matching template");
}
if (message_queue.isEmpty()) {
...
if (value_redirect != null) {
value_redirect.set_values((IPL4asp__Types.ASP__ConnId__ReadyToRelease) my_head.message);
}
if (sender_pointer != null) {
sender_pointer.operator_assign(my_head.sender_component);
}
...
public void outgoing_public_send(final IPL4asp__Types.ASP__SendTo send_par) {
outgoing_send(send_par);
}

public void outgoing_public_send(final IPL4asp__Types.ASP__Send send_par) {
outgoing_send(send_par);
}

private void incoming_message(final IPL4asp__Types.ASP__RecvFrom incoming_par, final int sender_component) {
for (int i = 0; i < mapped_ports.size(); i++) {
if (mapped_ports.get(i) != null && mapped_ports.get(i).incoming_message_handler(incoming_par, "@IPL4asp_Types.ASP_RecvFrom", sender_component, new TitanFloat())) {
return;
}
}
if (!is_started) {
...
private void incoming_message(final Socket__API__Definitions.PortEvent incoming_par, final int sender_component) {
for (int i = 0; i < mapped_ports.size(); i++) {
if (mapped_ports.get(i) != null && mapped_ports.get(i).incoming_message_handler(incoming_par, "@Socket_API_Definitions.PortEvent", sender_component, new TitanFloat())) {
return;
}
}
if (!is_started) {
...
private void incoming_message(final IPL4asp__Types.ASP__ConnId__ReadyToRelease incoming_par, final int sender_component) {
for (int i = 0; i < mapped_ports.size(); i++) {
if (mapped_ports.get(i) != null && mapped_ports.get(i).incoming_message_handler(incoming_par, "@IPL4asp_Types.ASP_ConnId_ReadyToRelease", sender_component, new TitanFloat())) {
return;
}
}
if (!is_started) {
