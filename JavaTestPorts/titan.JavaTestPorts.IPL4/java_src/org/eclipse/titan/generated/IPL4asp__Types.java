...
super("IPL4asp_Types", module_type_enum.TTCN3_MODULE);
}
...
private void copy_value(final SSL__protocols otherValue) {
switch (otherValue.union_selection){
case ALT_SSLv2__supported:
field = new TitanBoolean((TitanBoolean)otherValue.field);
break;
...
if (list_index < 0) {
throw new TtcnError("Internal error: Index underflow in a value list template of union type @IPL4asp_Types.SSL_protocols.");
}
...
private void copy_value(final IPL4__ParamResult otherValue) {
switch (otherValue.union_selection){
case ALT_local:
field = new Socket__API__Definitions.Socket((Socket__API__Definitions.Socket)otherValue.field);
break;
case ALT_remote:
field = new Socket__API__Definitions.Socket((Socket__API__Definitions.Socket)otherValue.field);
break;
case ALT_proto:
field = new Socket__API__Definitions.ProtoTuple((Socket__API__Definitions.ProtoTuple)otherValue.field);
break;
case ALT_userData:
...
if (list_index < 0) {
throw new TtcnError("Internal error: Index underflow in a value list template of union type @IPL4asp_Types.IPL4_ParamResult.");
}
if(list_index >= value_list.size()) {
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.IPL4_ParamResult" : name));
	...
	public static class SSL__cert__options extends Base_Type {
		...
		@Override
		public boolean is_bound() {
			if ( optional_sel.OPTIONAL_OMIT.equals(ssl__key__file.get_selection()) || ssl__key__file.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(ssl__certificate__file.get_selection()) || ssl__certificate__file.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(ssl__trustedCAlist__file.get_selection()) || ssl__trustedCAlist__file.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(ssl__cipher__list.get_selection()) || ssl__cipher__list.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(ssl__password.get_selection()) || ssl__password.is_bound() ) { return true; }
			return false;
		}
		...
		@Override
		public boolean is_value() {
			if ( !optional_sel.OPTIONAL_OMIT.equals(ssl__key__file.get_selection()) && !ssl__key__file.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(ssl__certificate__file.get_selection()) && !ssl__certificate__file.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(ssl__trustedCAlist__file.get_selection()) && !ssl__trustedCAlist__file.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(ssl__cipher__list.get_selection()) && !ssl__cipher__list.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(ssl__password.get_selection()) && !ssl__password.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final SSL__cert__options otherValue) {
			if ( !this.ssl__key__file.operator_equals( otherValue.ssl__key__file ) ) { return false; }
			if ( !this.ssl__certificate__file.operator_equals( otherValue.ssl__certificate__file ) ) { return false; }
			if ( !this.ssl__trustedCAlist__file.operator_equals( otherValue.ssl__trustedCAlist__file ) ) { return false; }
			if ( !this.ssl__cipher__list.operator_equals( otherValue.ssl__cipher__list ) ) { return false; }
			if ( !this.ssl__password.operator_equals( otherValue.ssl__password ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof SSL__cert__options ) {
				return operator_equals((SSL__cert__options) otherValue);
			}
...
@Override
		...
		public boolean is_bound() {
			...
			if (ssl__key__file.is_omit() || ssl__key__file.is_bound()) {
				return true;
			}
			if (ssl__certificate__file.is_omit() || ssl__certificate__file.is_bound()) {
				return true;
			}
			if (ssl__trustedCAlist__file.is_omit() || ssl__trustedCAlist__file.is_bound()) {
				return true;
			}
			if (ssl__cipher__list.is_omit() || ssl__cipher__list.is_bound()) {
				return true;
			}
			if (ssl__password.is_omit() || ssl__password.is_bound()) {
				return true;
			}
			return false;
		}
...
@Override
		...
		public boolean is_value() {
			...
			if (!ssl__key__file.is_omit() && !ssl__key__file.is_value()) {
				return false;
			}
			if (!ssl__certificate__file.is_omit() && !ssl__certificate__file.is_value()) {
				return false;
			}
			if (!ssl__trustedCAlist__file.is_omit() && !ssl__trustedCAlist__file.is_value()) {
				return false;
			}
			if (!ssl__cipher__list.is_omit() && !ssl__cipher__list.is_value()) {
				return false;
			}
			if (!ssl__password.is_omit() && !ssl__password.is_value()) {
				return false;
			}
			return true;
		}
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				ssl__key__file.operator_assign(template_sel.ANY_OR_OMIT);
				ssl__certificate__file.operator_assign(template_sel.ANY_OR_OMIT);
				ssl__trustedCAlist__file.operator_assign(template_sel.ANY_OR_OMIT);
				ssl__cipher__list.operator_assign(template_sel.ANY_OR_OMIT);
				ssl__password.operator_assign(template_sel.ANY_OR_OMIT);
			}
		}
	}
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.SSL_cert_options" : name));
	...
	public static class ASP__RecvFrom extends Base_Type {
		...
		@Override
		public boolean is_bound() {
			if ( connId.is_bound() ) { return true; }
			if ( remName.is_bound() ) { return true; }
			if ( remPort.is_bound() ) { return true; }
			if ( locName.is_bound() ) { return true; }
			if ( locPort.is_bound() ) { return true; }
			if ( proto.is_bound() ) { return true; }
			if ( userData.is_bound() ) { return true; }
			if ( msg.is_bound() ) { return true; }
			return false;
		}
		...
		@Override
		public boolean is_value() {
			if ( !connId.is_value() ) { return false; }
			if ( !remName.is_value() ) { return false; }
			if ( !remPort.is_value() ) { return false; }
			if ( !locName.is_value() ) { return false; }
			if ( !locPort.is_value() ) { return false; }
			if ( !proto.is_value() ) { return false; }
			if ( !userData.is_value() ) { return false; }
			if ( !msg.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final ASP__RecvFrom otherValue) {
			if ( !this.connId.operator_equals( otherValue.connId ) ) { return false; }
			if ( !this.remName.operator_equals( otherValue.remName ) ) { return false; }
			if ( !this.remPort.operator_equals( otherValue.remPort ) ) { return false; }
			if ( !this.locName.operator_equals( otherValue.locName ) ) { return false; }
			if ( !this.locPort.operator_equals( otherValue.locPort ) ) { return false; }
			if ( !this.proto.operator_equals( otherValue.proto ) ) { return false; }
			if ( !this.userData.operator_equals( otherValue.userData ) ) { return false; }
			if ( !this.msg.operator_equals( otherValue.msg ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof ASP__RecvFrom ) {
				return operator_equals((ASP__RecvFrom) otherValue);
			}
...
@Override
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				connId.operator_assign(template_sel.ANY_VALUE);
				remName.operator_assign(template_sel.ANY_VALUE);
				remPort.operator_assign(template_sel.ANY_VALUE);
				locName.operator_assign(template_sel.ANY_VALUE);
				locPort.operator_assign(template_sel.ANY_VALUE);
				proto.operator_assign(template_sel.ANY_VALUE);
				userData.operator_assign(template_sel.ANY_VALUE);
				msg.operator_assign(template_sel.ANY_VALUE);
			}
		}
	}
...
// originally operator<
public boolean isLessThan(final IPL4__DigestMethods.enum_type otherValue){
...
// originally operator<
public boolean isLessThan(final IPL4__DigestMethods otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
...
// originally operator<=
public boolean isLessThanOrEqual(final IPL4__DigestMethods.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
return enum_value.enum_num <= otherValue.enum_num;
}

// originally operator<=
public boolean isLessThanOrEqual(final IPL4__DigestMethods otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
return  enum_value.enum_num <= otherValue.enum_value.enum_num ;
}
...
// originally operator>
public boolean isGreaterThan(final IPL4__DigestMethods.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
return enum_value.enum_num > otherValue.enum_num;
}

// originally operator>
public boolean isGreaterThan(final IPL4__DigestMethods otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
return  enum_value.enum_num > otherValue.enum_value.enum_num ;
}
...
// originally operator>=
public boolean isGreaterThanOrEqual(final IPL4__DigestMethods.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
return enum_value.enum_num >= otherValue.enum_num;
}

// originally operator>=
public boolean isGreaterThanOrEqual(final IPL4__DigestMethods otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__DigestMethods. ");
return  enum_value.enum_num >= otherValue.enum_value.enum_num ;
}
...
set_selection(otherValue);switch (otherValue.template_selection) {
case SPECIFIC_VALUE:
...
break;
default:
throw new TtcnError("Copying an uninitialized/unsupported template of enumerated type IPL4__DigestMethods.");
}
}
...
if (!IPL4__DigestMethods.isValidEnum(otherValue)) {
throw new TtcnError("Initializing a template of enumerated type IPL4__DigestMethods with unknown numeric value "+ otherValue +".");
}
...
super(template_sel.SPECIFIC_VALUE);
otherValue.must_bound("Creating a template from an unbound value of enumerated type IPL4__DigestMethods. ");
...
if (!IPL4__DigestMethods.isValidEnum(otherValue)) {
throw new TtcnError("Assigning unknown numeric value " + otherValue + " to a template of enumerated type IPL4__DigestMethods.");
}
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
return this;
...
otherValue.must_bound("Assignment of an unbound value of enumerated type IPL4__DigestMethods to a template. ");
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
single_value = otherValue.enum_value;
return this;
...
throw new TtcnError(MessageFormat.format("Internal Error: value `IPL4__DigestMethods'_template can not be cast to {1}", otherValue));
}
...
return template_selection == template_sel.COMPLEMENTED_LIST;
default:
throw new TtcnError("Matching with an uninitialized/unsupported template of enumerated type IPL4__DigestMethods.");
}
}
...
if (template_selection != template_sel.SPECIFIC_VALUE || is_ifPresent) {
throw new TtcnError("Performing a valueof or send operation on a non-specific template of enumerated type IPL4__DigestMethods.");
}
...
throw new TtcnError("Setting an invalid list type for a template of enumerated type IPL4__DigestMethods.");
}
clean_up();
...
if (template_selection != template_sel.VALUE_LIST && template_selection != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Accessing a list element of a non-list template of enumerated type IPL4__DigestMethods.");
}
if (list_index < 0) {
throw new TtcnError("Index underflow in a value list template of enumerated type IPL4__DigestMethods.");
}
if(list_index >= value_list.size()) {
throw new TtcnError("Index overflow in a value list template of enumerated type IPL4__DigestMethods.");
}
return value_list.get(list_index);
}
...
switch (template_selection) {
case SPECIFIC_VALUE:
TTCN_Logger.log_event_enum(IPL4__DigestMethods.enum2str(single_value), IPL4__DigestMethods.enum2int(single_value));
break;
case COMPLEMENTED_LIST:
TTCN_Logger.log_event_str("complement");
case VALUE_LIST:
...
if (!IPL4__DigestMethods.isValidEnum(enum_value)) {
param.error("Invalid enumerated value for type @IPL4asp_Types.IPL4_DigestMethods.");
}
...
case SPECIFIC_VALUE:{
final int temp = text_buf.pull_int().getInt();
if (!IPL4__DigestMethods.isValidEnum(temp)) {
throw new TtcnError(MessageFormat.format("Text decoder: Unknown numeric value {0} was received for enumerated type @IPL4asp_Types.IPL4_DigestMethods.", temp));
}
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.IPL4_DigestMethods" : name));
	...
	public static class ReuseAddress extends Base_Type {
		...
		@Override
		public boolean is_bound() {
			if ( optional_sel.OPTIONAL_OMIT.equals(enable.get_selection()) || enable.is_bound() ) { return true; }
			return false;
		}
		...
		@Override
		public boolean is_value() {
			if ( !optional_sel.OPTIONAL_OMIT.equals(enable.get_selection()) && !enable.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final ReuseAddress otherValue) {
			if ( !this.enable.operator_equals( otherValue.enable ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof ReuseAddress ) {
				return operator_equals((ReuseAddress) otherValue);
			}
...
@Override
		...
		public boolean is_bound() {
			...
			if (enable.is_omit() || enable.is_bound()) {
				return true;
			}
			return false;
		}
...
@Override
		...
		public boolean is_value() {
			...
			if (!enable.is_omit() && !enable.is_value()) {
				return false;
			}
			return true;
		}
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				enable.operator_assign(template_sel.ANY_OR_OMIT);
			}
		}
	}
...
public static class SSL__proto__support extends Base_Type {
	...
	private List<SSL__protocols> valueElements;
	...
	public SSL__proto__support operator_concatenate(final TitanNull_Type nullValue) {
...
public static class SSL__proto__support_template extends Record_Of_Template {
	...
	private List<SSL__protocols_template> value_elements;

	//originally value_list/list_value
	private List<SSL__proto__support_template> list_value;
	...
	private void copy_value(final SSL__proto__support other_value) {
	...
	private int get_length_for_concat(final SSL__proto__support operand) {
	...
	private void concat(final AtomicInteger pos, final SSL__proto__support_template operand) {
		...
		case SPECIFIC_VALUE:
			for (int i = 0; i < operand.value_elements.size(); ++i) {
				value_elements.set( pos.get() + i, new SSL__protocols_template(operand.value_elements.get(i)) );
			}
		...
		case ANY_OR_OMIT:
			...
			case NO_LENGTH_RESTRICTION:
				// ? => { * }
				value_elements.set( pos.get(), new SSL__protocols_template( template_sel.ANY_OR_OMIT ) );
				pos.incrementAndGet();
				break;
			case RANGE_LENGTH_RESTRICTION:
			case SINGLE_LENGTH_RESTRICTION: {
				...
				for (int i = 0; i < N; ++i) {
					value_elements.set( pos.get() + i, new SSL__protocols_template( template_sel.ANY_VALUE ) );
				}
				pos.addAndGet( N );
				break; }
			}
	...
	private boolean matchv(final SSL__proto__support other_value, final boolean legacy) {
		if (!other_value.is_bound()) {
			return false;
		}
		final int value_length = other_value.size_of().getInt();
		...
		case COMPLEMENTED_LIST:
			...
			return template_selection == template_sel.COMPLEMENTED_LIST;
		default:
			throw new TtcnError("Matching with an uninitialized/unsupported template of type SSL__proto__support.");
		}
	}
...
set_length_range(param);
	...
	public static class ASP__SendTo extends Base_Type {
		...
		public boolean is_bound() {
			...
			if ( remName.is_bound() ) { return true; }
			if ( remPort.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(proto.get_selection()) || proto.is_bound() ) { return true; }
			if ( msg.is_bound() ) { return true; }
			return false;
		}
		...
		public boolean is_value() {
			...
			if ( !remName.is_value() ) { return false; }
			if ( !remPort.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(proto.get_selection()) && !proto.is_value() ) { return false; }
			if ( !msg.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final ASP__SendTo otherValue) {
			if ( !this.connId.operator_equals( otherValue.connId ) ) { return false; }
			if ( !this.remName.operator_equals( otherValue.remName ) ) { return false; }
			if ( !this.remPort.operator_equals( otherValue.remPort ) ) { return false; }
			if ( !this.proto.operator_equals( otherValue.proto ) ) { return false; }
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof ASP__SendTo ) {
				return operator_equals((ASP__SendTo) otherValue);
			}
...
@Override
		...
		public boolean is_bound() {
			...
			if (proto.is_omit() || proto.is_bound()) {
				return true;
			}
			if (msg.is_bound()) {
				return true;
...
@Override
		...
		public boolean is_value() {
			...
			if (!proto.is_omit() && !proto.is_value()) {
				return false;
			}
			if (!msg.is_value()) {
				return false;
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				...
				remName.operator_assign(template_sel.ANY_VALUE);
				remPort.operator_assign(template_sel.ANY_VALUE);
				proto.operator_assign(template_sel.ANY_OR_OMIT);
				msg.operator_assign(template_sel.ANY_VALUE);
			}
		}
	}
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.ASP_SendTo" : name));
	...
	public static class SctpEventHandle extends Base_Type {
		...
		@Override
		public boolean is_bound() {
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__data__io__event.get_selection()) || sctp__data__io__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__association__event.get_selection()) || sctp__association__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__address__event.get_selection()) || sctp__address__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__send__failure__event.get_selection()) || sctp__send__failure__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__peer__error__event.get_selection()) || sctp__peer__error__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__shutdown__event.get_selection()) || sctp__shutdown__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__partial__delivery__event.get_selection()) || sctp__partial__delivery__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__adaptation__layer__event.get_selection()) || sctp__adaptation__layer__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__authentication__event.get_selection()) || sctp__authentication__event.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(sctp__sender__dry__event.get_selection()) || sctp__sender__dry__event.is_bound() ) { return true; }
			return false;
		}
		...
		@Override
		public boolean is_value() {
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__data__io__event.get_selection()) && !sctp__data__io__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__association__event.get_selection()) && !sctp__association__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__address__event.get_selection()) && !sctp__address__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__send__failure__event.get_selection()) && !sctp__send__failure__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__peer__error__event.get_selection()) && !sctp__peer__error__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__shutdown__event.get_selection()) && !sctp__shutdown__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__partial__delivery__event.get_selection()) && !sctp__partial__delivery__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__adaptation__layer__event.get_selection()) && !sctp__adaptation__layer__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__authentication__event.get_selection()) && !sctp__authentication__event.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(sctp__sender__dry__event.get_selection()) && !sctp__sender__dry__event.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final SctpEventHandle otherValue) {
			if ( !this.sctp__data__io__event.operator_equals( otherValue.sctp__data__io__event ) ) { return false; }
			if ( !this.sctp__association__event.operator_equals( otherValue.sctp__association__event ) ) { return false; }
			if ( !this.sctp__address__event.operator_equals( otherValue.sctp__address__event ) ) { return false; }
			if ( !this.sctp__send__failure__event.operator_equals( otherValue.sctp__send__failure__event ) ) { return false; }
			if ( !this.sctp__peer__error__event.operator_equals( otherValue.sctp__peer__error__event ) ) { return false; }
			if ( !this.sctp__shutdown__event.operator_equals( otherValue.sctp__shutdown__event ) ) { return false; }
			if ( !this.sctp__partial__delivery__event.operator_equals( otherValue.sctp__partial__delivery__event ) ) { return false; }
			if ( !this.sctp__adaptation__layer__event.operator_equals( otherValue.sctp__adaptation__layer__event ) ) { return false; }
			if ( !this.sctp__authentication__event.operator_equals( otherValue.sctp__authentication__event ) ) { return false; }
			if ( !this.sctp__sender__dry__event.operator_equals( otherValue.sctp__sender__dry__event ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof SctpEventHandle ) {
				return operator_equals((SctpEventHandle) otherValue);
			}
...
@Override
		...
		public boolean is_bound() {
			...
			if (sctp__data__io__event.is_omit() || sctp__data__io__event.is_bound()) {
				return true;
			}
			if (sctp__association__event.is_omit() || sctp__association__event.is_bound()) {
				return true;
			}
			if (sctp__address__event.is_omit() || sctp__address__event.is_bound()) {
				return true;
			}
			if (sctp__send__failure__event.is_omit() || sctp__send__failure__event.is_bound()) {
				return true;
			}
			if (sctp__peer__error__event.is_omit() || sctp__peer__error__event.is_bound()) {
				return true;
			}
			if (sctp__shutdown__event.is_omit() || sctp__shutdown__event.is_bound()) {
				return true;
			}
			if (sctp__partial__delivery__event.is_omit() || sctp__partial__delivery__event.is_bound()) {
				return true;
			}
			if (sctp__adaptation__layer__event.is_omit() || sctp__adaptation__layer__event.is_bound()) {
				return true;
			}
			if (sctp__authentication__event.is_omit() || sctp__authentication__event.is_bound()) {
				return true;
			}
			if (sctp__sender__dry__event.is_omit() || sctp__sender__dry__event.is_bound()) {
				return true;
			}
			return false;
		}
...
@Override
		...
		public boolean is_value() {
			...
			if (!sctp__data__io__event.is_omit() && !sctp__data__io__event.is_value()) {
				return false;
			}
			if (!sctp__association__event.is_omit() && !sctp__association__event.is_value()) {
				return false;
			}
			if (!sctp__address__event.is_omit() && !sctp__address__event.is_value()) {
				return false;
			}
			if (!sctp__send__failure__event.is_omit() && !sctp__send__failure__event.is_value()) {
				return false;
			}
			if (!sctp__peer__error__event.is_omit() && !sctp__peer__error__event.is_value()) {
				return false;
			}
			if (!sctp__shutdown__event.is_omit() && !sctp__shutdown__event.is_value()) {
				return false;
			}
			if (!sctp__partial__delivery__event.is_omit() && !sctp__partial__delivery__event.is_value()) {
				return false;
			}
			if (!sctp__adaptation__layer__event.is_omit() && !sctp__adaptation__layer__event.is_value()) {
				return false;
			}
			if (!sctp__authentication__event.is_omit() && !sctp__authentication__event.is_value()) {
				return false;
			}
			if (!sctp__sender__dry__event.is_omit() && !sctp__sender__dry__event.is_value()) {
				return false;
			}
			return true;
		}
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				sctp__data__io__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__association__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__address__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__send__failure__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__peer__error__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__shutdown__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__partial__delivery__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__adaptation__layer__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__authentication__event.operator_assign(template_sel.ANY_OR_OMIT);
				sctp__sender__dry__event.operator_assign(template_sel.ANY_OR_OMIT);
			}
		}
	}
...
// originally operator<
public boolean isLessThan(final IPL4__IPAddressType.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
return enum_value.enum_num < otherValue.enum_num;
}

// originally operator<
public boolean isLessThan(final IPL4__IPAddressType otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
...
// originally operator<=
public boolean isLessThanOrEqual(final IPL4__IPAddressType.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
return enum_value.enum_num <= otherValue.enum_num;
}

// originally operator<=
public boolean isLessThanOrEqual(final IPL4__IPAddressType otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
return  enum_value.enum_num <= otherValue.enum_value.enum_num ;
}
...
// originally operator>
public boolean isGreaterThan(final IPL4__IPAddressType.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
return enum_value.enum_num > otherValue.enum_num;
}

// originally operator>
public boolean isGreaterThan(final IPL4__IPAddressType otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
return  enum_value.enum_num > otherValue.enum_value.enum_num ;
}
...
// originally operator>=
public boolean isGreaterThanOrEqual(final IPL4__IPAddressType.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
return enum_value.enum_num >= otherValue.enum_num;
}

// originally operator>=
public boolean isGreaterThanOrEqual(final IPL4__IPAddressType otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__IPAddressType. ");
return  enum_value.enum_num >= otherValue.enum_value.enum_num ;
}
...
break;
default:
throw new TtcnError("Copying an uninitialized/unsupported template of enumerated type IPL4__IPAddressType.");
}
}
...
super(template_sel.SPECIFIC_VALUE);
if (!IPL4__IPAddressType.isValidEnum(otherValue)) {
throw new TtcnError("Initializing a template of enumerated type IPL4__IPAddressType with unknown numeric value "+ otherValue +".");
}
...
super(template_sel.SPECIFIC_VALUE);
otherValue.must_bound("Creating a template from an unbound value of enumerated type IPL4__IPAddressType. ");
single_value = otherValue.enum_value;
}
...
if (!IPL4__IPAddressType.isValidEnum(otherValue)) {
throw new TtcnError("Assigning unknown numeric value " + otherValue + " to a template of enumerated type IPL4__IPAddressType.");
}
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
return this;
...
otherValue.must_bound("Assignment of an unbound value of enumerated type IPL4__IPAddressType to a template. ");
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
single_value = otherValue.enum_value;
return this;
...
throw new TtcnError(MessageFormat.format("Internal Error: value `IPL4__IPAddressType'_template can not be cast to {1}", otherValue));
}
...
return template_selection == template_sel.COMPLEMENTED_LIST;
default:
throw new TtcnError("Matching with an uninitialized/unsupported template of enumerated type IPL4__IPAddressType.");
}
}
...
if (template_selection != template_sel.SPECIFIC_VALUE || is_ifPresent) {
throw new TtcnError("Performing a valueof or send operation on a non-specific template of enumerated type IPL4__IPAddressType.");
}
...
public void set_type(final template_sel templateType, final int list_length) {
if (templateType != template_sel.VALUE_LIST && templateType != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Setting an invalid list type for a template of enumerated type IPL4__IPAddressType.");
}
clean_up();
set_selection(templateType);
...
if (template_selection != template_sel.VALUE_LIST && template_selection != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Accessing a list element of a non-list template of enumerated type IPL4__IPAddressType.");
}
if (list_index < 0) {
throw new TtcnError("Index underflow in a value list template of enumerated type IPL4__IPAddressType.");
}
if(list_index >= value_list.size()) {
throw new TtcnError("Index overflow in a value list template of enumerated type IPL4__IPAddressType.");
}
return value_list.get(list_index);
}
...
switch (template_selection) {
case SPECIFIC_VALUE:
TTCN_Logger.log_event_enum(IPL4__IPAddressType.enum2str(single_value), IPL4__IPAddressType.enum2int(single_value));
break;
case COMPLEMENTED_LIST:
TTCN_Logger.log_event_str("complement");
case VALUE_LIST:
...
if (!IPL4__IPAddressType.isValidEnum(enum_value)) {
param.error("Invalid enumerated value for type @IPL4asp_Types.IPL4_IPAddressType.");
}
operator_assign(enum_value);
break;
...
case SPECIFIC_VALUE:{
final int temp = text_buf.pull_int().getInt();
if (!IPL4__IPAddressType.isValidEnum(temp)) {
throw new TtcnError(MessageFormat.format("Text decoder: Unknown numeric value {0} was received for enumerated type @IPL4asp_Types.IPL4_IPAddressType.", temp));
}
...
public static class Option_alpn__list extends Base_Type {
	...
	public Option_alpn__list( final Option_alpn__list otherValue ) {
		otherValue.must_bound("Copying an unbound value of type @IPL4asp_Types.Option.alpn_list.");
		valueElements = copy_list( otherValue.valueElements );
	}


	public Option_alpn__list(final TitanNull_Type nullValue) {
	...
	@Override
	public boolean operator_equals(final Base_Type otherValue) {
		if (otherValue instanceof Option_alpn__list) {
			return operator_equals((Option_alpn__list)otherValue);
		}
		throw new TtcnError("Internal Error: The left operand of comparison is not of type Option_alpn__list.");
	}

	public boolean operator_equals( final Option_alpn__list otherValue ) {
		must_bound("The left operand of comparison is an unbound value of type @IPL4asp_Types.Option.alpn_list.");
		otherValue.must_bound("The right operand of comparison is an unbound value of type @IPL4asp_Types.Option.alpn_list.");
	...
	@Override
	public Option_alpn__list operator_assign(final Base_Type otherValue) {
	if (otherValue instanceof Option_alpn__list) {
		return operator_assign((Option_alpn__list)otherValue);
	}

		throw new TtcnError("Internal Error: The left operand of assignment is not of type Option_alpn__list.");
	}

	public Option_alpn__list operator_assign( final Option_alpn__list otherValue ) {
		otherValue.must_bound( "Assigning an unbound value of type @IPL4asp_Types.Option.alpn_list." );

		valueElements = copy_list( otherValue.valueElements );
		return this;
	}

	public Option_alpn__list operator_assign(final TitanNull_Type nullValue) {
		valueElements = new ArrayList<TitanCharString>();
		return this;
	}

	//originally operator+
	public Option_alpn__list operator_concatenate(final Option_alpn__list other_value) {
		if (valueElements == null || other_value.valueElements == null) {
			throw new TtcnError("Unbound operand of @IPL4asp_Types.Option.alpn_list concatenation.");
		}
	...
	public Option_alpn__list operator_concatenate(final TitanNull_Type nullValue) {
		return new Option_alpn__list(this);
	}

	//originally operator<<=
	public Option_alpn__list rotate_left(final TitanInteger rotate_count) {
		rotate_count.must_bound("Unbound integer operand of rotate left operator.");
		return rotate_left(rotate_count.getInt());
	}

	//originally operator<<=
	public Option_alpn__list rotate_left(final int rotate_count) {
		return rotate_right(-rotate_count);
	}

	//originally operator>>=
	public Option_alpn__list rotate_right(final TitanInteger rotate_count) {
		rotate_count.must_bound("Unbound integer operand of rotate right operator.");
		return rotate_right(rotate_count.getInt());
	}

	//originally operator>>=
	public Option_alpn__list rotate_right(final int rotate_count) {
		must_bound("Performing rotation operation on an unbound value of type @IPL4asp_Types.Option.alpn_list.");
		final int size = valueElements.size();
		if (size == 0) {
			return new Option_alpn__list(TitanNull_Type.NULL_VALUE);
		}
		int rc;
		if (rotate_count >= 0) {
			rc = rotate_count % size;
...
@Override
	...
	public TitanCharString get_at( final int index_value ) {
		if (index_value < 0) {
			throw new TtcnError( "Accessing an element of type @IPL4asp_Types.Option.alpn_list using a negative index: "+index_value+".");
		}
	...
	public TitanCharString get_at(final TitanInteger index_value) {
		index_value.must_bound( "Using an unbound integer value for indexing a value of type @IPL4asp_Types.Option.alpn_list." );
		return get_at( index_value.getInt() );
	}

	public TitanCharString constGet_at( final int index_value ) {
			must_bound( "Accessing an element in an unbound value of type @IPL4asp_Types.Option.alpn_list." );
		if (index_value < 0) {
			throw new TtcnError( "Accessing an element of type @IPL4asp_Types.Option.alpn_list using a negative index: "+index_value+".");
		}
		final int nofElements = n_elem().getInt();
		if ( index_value >= nofElements ) {
			throw new TtcnError( "Index overflow in a value of type @IPL4asp_Types.Option.alpn_list: The index is "+index_value+", but the value has only "+nofElements+" elements." );
		}
	 ...
	 * */
	public TitanInteger size_of() {
		must_bound("Performing sizeof operation on an unbound value of type @IPL4asp_Types.Option.alpn_list.");
		return new TitanInteger(valueElements.size());
	}
	...
	public TitanInteger lengthof() {
		must_bound("Performing lengthof operation on an unbound value of type @IPL4asp_Types.Option.alpn_list.");
		for ( int i = valueElements.size() - 1; i >= 0; i-- ) {
			final TitanCharString elem = valueElements.get( i );
			if ( elem != null && elem.is_bound() ) {
				return new TitanInteger(i + 1);
	...
	public void set_size(final int newSize) {
		if (newSize < 0) {
			throw new TtcnError("Internal error: Setting a negative size for a value of type @IPL4asp_Types.Option.alpn_list.");
		}
		if ( valueElements == null ) {
			valueElements = new ArrayList<TitanCharString>();
		}
 ...
 *  */
	...
	public Option_alpn__list substr(final int index, final int returncount) {
			must_bound("The first argument of substr() is an unbound value of type @IPL4asp_Types.Option.alpn_list.");
		AdditionalFunctions.check_substr_arguments(valueElements.size(), index, returncount, "@IPL4asp_Types.Option.alpn_list","element");
		final Option_alpn__list ret_val = new Option_alpn__list(TitanNull_Type.NULL_VALUE);
		for (int i=0; i<returncount; i++) {
			if (valueElements.get(i+index) != null) {
	...
	public Option_alpn__list replace(final int index, final int len, final Option_alpn__list repl) {
			must_bound("The first argument of replace() is an unbound value of type @IPL4asp_Types.Option.alpn_list.");
			repl.must_bound("The fourth argument of replace() is an unbound value of type @IPL4asp_Types.Option.alpn_list.");
		AdditionalFunctions.check_replace_arguments(valueElements.size(), index, len, "@IPL4asp_Types.Option.alpn_list","element");
		final Option_alpn__list ret_val = new Option_alpn__list(TitanNull_Type.NULL_VALUE);
		for (int i = 0; i < index; i++) {
			final TitanCharString elem = valueElements.get(i);
			if (elem != null) {
	...
	public Option_alpn__list replace(final int index, final int len, final Option_alpn__list_template repl) {
		if (!repl.is_value()) {
			throw new TtcnError("The fourth argument of function replace() is a template with non-specific value.");
		}
		return replace(index, len, repl.valueof());
	...
	public Option_alpn__list replace(final int index, final TitanInteger len, final Option_alpn__list_template repl) {
		if (!repl.is_value()) {
			throw new TtcnError("The fourth argument of function replace() is a template with non-specific value.");
		}
		return replace(index, len.getInt(), repl.valueof());
	...
	public Option_alpn__list replace(final TitanInteger index, final int len, final Option_alpn__list_template repl) {
		if (!repl.is_value()) {
			throw new TtcnError("The fourth argument of function replace() is a template with non-specific value.");
		}
		return replace(index.getInt(), len, repl.valueof());
	...
	public Option_alpn__list replace(final TitanInteger index, final TitanInteger len, final Option_alpn__list_template repl) {
		if (!repl.is_value()) {
			throw new TtcnError("The fourth argument of function replace() is a template with non-specific value.");
		}
		return replace(index.getInt(), len.getInt(), repl.valueof());
...
break;
default:
param.type_error("record of value", "@IPL4asp_Types.Option.alpn_list");
}
break;
case OT_CONCAT:
switch (param.get_type()) {
...
throw new TtcnError("Internal error: Unknown operation type");
		...
		@Override
		public void encode_text(final Text_Buf text_buf) {
			must_bound("Text encoder: Encoding an unbound value of type @IPL4asp_Types.Option.alpn_list.");
			text_buf.push_int(valueElements.size());
			for (int i = 0; i < valueElements.size(); i++) {
				valueElements.get(i).encode_text(text_buf);
			}
...
public static class Option_alpn__list_template extends Record_Of_Template {

	//originally single_value/value_elements
	private List<TitanCharString_template> value_elements;

	//originally value_list/list_value
	private List<Option_alpn__list_template> list_value;

	private final match_function_t match_function_specific = new match_function_t() {
		@Override
		public boolean match(final Base_Type value_ptr, final int value_index, final Restricted_Length_Template template_ptr, final int template_index, final boolean legacy) {
			return match_index((Option_alpn__list)value_ptr, value_index, (Option_alpn__list_template)template_ptr, template_index, legacy);
		}
	};
	...
	public Option_alpn__list_template(final template_sel otherValue ) {
		super( otherValue );
		check_single_selection( otherValue );
	}

	public Option_alpn__list_template( final Option_alpn__list otherValue ) {
		copy_value( otherValue );
	}

	public Option_alpn__list_template( final Option_alpn__list_template otherValue ) {
		copy_template( otherValue );
	}

	public Option_alpn__list_template( final Optional<Option_alpn__list> otherValue ) {
		switch (otherValue.get_selection()) {
		case OPTIONAL_PRESENT:
			copy_value(otherValue.constGet());
			break;
	...
	public Option_alpn__list_template( final TitanNull_Type nullValue ) {
		super( template_sel.SPECIFIC_VALUE );
		value_elements = new ArrayList<TitanCharString_template>();
	}

	private void copy_value(final Option_alpn__list other_value) {
			other_value.must_bound("Initialization of a template of type @IPL4asp_Types.Option.alpn_list with an unbound value.");
		value_elements = new ArrayList<TitanCharString_template>();
		final int otherSize = other_value.valueElements.size();
		for (int elem_count = 0; elem_count < otherSize; elem_count++) {
			if (other_value.constGet_at(elem_count).is_bound()) {
	...
	private void copy_template(final Option_alpn__list_template other_value) {
		switch (other_value.template_selection) {
		case SPECIFIC_VALUE:
			value_elements = new ArrayList<TitanCharString_template>();
			final int otherSize = other_value.value_elements.size();
		...
		case VALUE_LIST:
		case COMPLEMENTED_LIST:
			list_value = new ArrayList<Option_alpn__list_template>(other_value.list_value.size());
			for(int i = 0; i < other_value.list_value.size(); i++) {
				final Option_alpn__list_template temp = new Option_alpn__list_template(other_value.list_value.get(i));
				list_value.add(temp);
			}
			break;
		default:
			throw new TtcnError("Copying an uninitialized template of type @IPL4asp_Types.Option.alpn_list.");
		}
		set_selection(other_value);
	}

	public boolean match(final Option_alpn__list other_value) {
		return match(other_value, false);
	}

	public boolean match(final Option_alpn__list other_value, final boolean legacy) {
		if(!other_value.is_bound()) {
			return false;
		}
		final int value_length = other_value.size_of().getInt();
		...
		case COMPLEMENTED_LIST:
			...
			return template_selection == template_sel.COMPLEMENTED_LIST;
		default:
			throw new TtcnError("Matching with an uninitialized/unsupported template of type @IPL4asp_Types.Option.alpn_list.");
		}
	}

	private boolean match_index(final Option_alpn__list value_ptr, final int value_index, final Option_alpn__list_template template_ptr, final int template_index, final boolean legacy) {
		if (value_index >= 0) {
			return template_ptr.value_elements.get(template_index).match(value_ptr.valueElements.get(value_index), legacy);
		} else {
			return template_ptr.value_elements.get(template_index).is_any_or_omit();
	...
	public boolean match(final Base_Type otherValue, final boolean legacy) {
		if (otherValue instanceof Option_alpn__list) {
			return match((Option_alpn__list)otherValue, legacy);
		}
	...
	@Override
	public Option_alpn__list_template operator_assign( final template_sel otherValue ) {
		check_single_selection(otherValue);
		clean_up();
		set_selection(otherValue);
		return this;
	...
	public Option_alpn__list_template operator_assign( final Option_alpn__list otherValue ) {
		clean_up();
		copy_value(otherValue);
		return this;
	}

	public Option_alpn__list_template operator_assign( final Option_alpn__list_template otherValue ) {
		if (otherValue != this) {
			clean_up();
			copy_template(otherValue);
		}
	...
	@Override
	public Option_alpn__list_template operator_assign(final Base_Type otherValue) {
	if (otherValue instanceof Option_alpn__list) {
		return operator_assign((Option_alpn__list)otherValue);
	}
	...
	@Override
	public Option_alpn__list_template operator_assign(final Base_Template otherValue) {
	if (otherValue instanceof Option_alpn__list_template) {
		return operator_assign((Option_alpn__list_template)otherValue);
	}

		throw new TtcnError("Internal Error: The left operand of assignment is not of type Option_alpn__list_template.");
	}

	public Option_alpn__list_template operator_assign( final Optional<Option_alpn__list> other_value ) {
		clean_up();
		switch (other_value.get_selection()) {
		case OPTIONAL_PRESENT:
			copy_value(other_value.constGet());
		...
		case OPTIONAL_OMIT:
			...
			break;
		default:
			throw new TtcnError("Assignment of an unbound optional field to a template of type @IPL4asp_Types.Option.alpn_list.");
		}
		return this;
	}
	...
	public Option_alpn__list replace(final TitanInteger index, final TitanInteger len, final Option_alpn__list repl) {
		if (!is_value()) {
			throw new TtcnError("The first argument of function replace() is a template with non-specific value.");
		}
		return valueof().replace(index.getInt(), len.getInt(), repl);
	...
	public TitanCharString_template get_at(final int index_value) {
		if (index_value < 0) {
			throw new TtcnError( MessageFormat.format( "Accessing an element of a template for type @IPL4asp_Types.Option.alpn_list using a negative index: {0}.", index_value ) );
		}
		...
		case UNINITIALIZED_TEMPLATE:
			...
			break;
		default:
			throw new TtcnError("Accessing an element of a non-specific template for type @IPL4asp_Types.Option.alpn_list.");
		}
		return value_elements.get(index_value);
	}

	public TitanCharString_template get_at(final TitanInteger index_value) {
			index_value.must_bound("Using an unbound integer value for indexing a template of type @IPL4asp_Types.Option.alpn_list.");
	...
	public TitanCharString_template constGet_at(final int index_value) {
		...
		if (index_value >= value_elements.size()) {
			throw new TtcnError( MessageFormat.format( "Index overflow in a template of type @IPL4asp_Types.Option.alpn_list: The index is {0}, but the template has only {1} elements.", index_value, value_elements.size() ) );
		}
	...
	private int get_length_for_concat(final Option_alpn__list operand) {
		operand.must_bound("Operand of record of template concatenation is an unbound value.");
		return operand.valueElements.size();
	}
	...
	private int get_length_for_concat(final template_sel operand) {
		...
		throw new TtcnError("Operand of record of template concatenation is an uninitialized or unsupported template.");
			...
			//TODO: simplify, just use value_elements.add()
	private void concat(final AtomicInteger pos, final Option_alpn__list_template operand) {
		// all errors should have already been caught by the operand's
		// get_length_for_concat() call;
		// the result template (this) should already be set to SPECIFIC_VALUE and
		// single_value.value_elements should already be allocated
	...
	public void set_size(final int new_size) {
		if (new_size < 0) {
			throw new TtcnError("Internal error: Setting a negative size for a template of type @IPL4asp_Types.Option.alpn_list.");
		}
		final template_sel old_selection = template_selection;
		if (old_selection != template_sel.SPECIFIC_VALUE) {
			clean_up();
	...
	public TitanInteger sizeOf(final boolean is_size) {
		final String op_name = is_size ? "size" : "length";
		if (is_ifPresent) {
			throw new TtcnError( MessageFormat.format( "Performing {0}of() operation on a template of type @IPL4asp_Types.Option.alpn_list which has an ifpresent attribute.", op_name ) );
		}
		int min_size;
		boolean has_any_or_none;
		switch (template_selection)
		...
		case SPECIFIC_VALUE: {
			...
			for (int i=0; i<elem_count; i++)
			{
				...
				{
				case OMIT_VALUE:
					throw new TtcnError( MessageFormat.format( "Performing {0}of() operation on a template of type @IPL4asp_Types.Option.alpn_list containing omit element.", op_name ) );
				case ANY_OR_OMIT:
					has_any_or_none = true;
					break;
				default:
		...
		case OMIT_VALUE:
			throw new TtcnError( MessageFormat.format( "Performing {0}of() operation on a template of type @IPL4asp_Types.Option.alpn_list containing omit value.", op_name ) );
		case ANY_VALUE:
		case ANY_OR_OMIT:
			min_size = 0;
			has_any_or_none = true;
		...
		{
			if (list_value.isEmpty()) {
				throw new TtcnError( MessageFormat.format( "Performing {0}of() operation on a template of type @IPL4asp_Types.Option.alpn_list containing an empty list.", op_name ) );
			}
			final int item_size = list_value.get(0).sizeOf(is_size).getInt();
			for (int i = 1; i < list_value.size(); i++) {
				if (list_value.get(i).sizeOf(is_size).getInt()!=item_size) {
					throw new TtcnError( MessageFormat.format( "Performing {0}of() operation on a template of type @IPL4asp_Types.Option.alpn_list containing a value list with different sizes.", op_name ) );
				}
			}
			min_size = item_size;
			has_any_or_none = false;
		...
		case COMPLEMENTED_LIST:
			throw new TtcnError( MessageFormat.format( "Performing {0}of() operation on a template of type @IPL4asp_Types.Option.alpn_list containing complemented list.", op_name ) );
		default:
			throw new TtcnError( MessageFormat.format( "Performing {0}of() operation on an uninitialized/unsupported template of type Option_alpn__list.", op_name ) );
		}
	...
	public TitanInteger n_elem() {
		...
		case SPECIFIC_VALUE:
			return new TitanInteger(value_elements.size());
		case COMPLEMENTED_LIST:
			throw new TtcnError("Performing n_elem() operation on a template of type Option_alpn__list containing complemented list.");
		case UNINITIALIZED_TEMPLATE:
		case OMIT_VALUE:
		case ANY_VALUE:
		case ANY_OR_OMIT:
		...
		throw new TtcnError("Performing n_elem() operation on an uninitialized/unsupported template of type Option_alpn__list.");
	}

	private boolean matchv(final Option_alpn__list other_value, final boolean legacy) {
		if (!other_value.is_bound()) {
			return false;
		}
		final int value_length = other_value.size_of().getInt();
		...
		case COMPLEMENTED_LIST:
			...
			return template_selection == template_sel.COMPLEMENTED_LIST;
		default:
			throw new TtcnError("Matching with an uninitialized/unsupported template of type Option_alpn__list.");
		}
	}
...
@Override
	public void set_type(final template_sel template_type, final int list_length) {
		...
		case VALUE_LIST:
		case COMPLEMENTED_LIST:
			list_value = new ArrayList<Option_alpn__list_template>( list_length );
			for (int list_count = 0; list_count < list_length; list_count++) {
...
@Override
		public Option_alpn__list_template list_item(final int list_index) {
			if (template_selection != template_sel.VALUE_LIST && template_selection != template_sel.COMPLEMENTED_LIST) {
				throw new TtcnError("Accessing a list element of a non-list template of type @IPL4asp_Types.Option.alpn_list.");
			}
			if (list_index >= list_value.size()) {
				throw new TtcnError("Index overflow in a value list template of type @IPL4asp_Types.Option.alpn_list.");
			}
			return list_value.get(list_index);
		}

	public Option_alpn__list_template get_list_item(final int list_index) {
		if (template_selection != template_sel.VALUE_LIST && template_selection != template_sel.COMPLEMENTED_LIST) {
			throw new TtcnError("Internal error: Accessing a list element of a non-list template of type @IPL4asp_Types.Option.alpn_list.");
		}
		if (list_index < 0) {
			throw new TtcnError( MessageFormat.format( "Internal error: Accessing a value list template of type @IPL4asp_Types.Option.alpn_list using a negative index ({0}).", list_index ) );
		}
		if (list_index >= list_value.size()) {
			throw new TtcnError("Internal error: Index overflow in a value list template of type @IPL4asp_Types.Option.alpn_list.");
		}
		return list_value.get( list_index );
	}
...
@Override
	...
	public void log_match(final Option_alpn__list match_value) {
		log_match(match_value, false);
	}

	@Override
	public void log_match(final Base_Type match_value, final boolean legacy) {
		if (match_value instanceof Option_alpn__list) {
			log_match((Option_alpn__list)match_value, legacy);
			return;
		}

		throw new TtcnError("Internal Error: value can not be cast to @IPL4asp_Types.Option.alpn_list.");
	}

	public void log_match(final Option_alpn__list match_value, final boolean legacy) {
		if ( TTCN_Logger.matching_verbosity_t.VERBOSITY_COMPACT == TTCN_Logger.get_matching_verbosity() ) {
			if(match(match_value, legacy)) {
				TTCN_Logger.print_logmatch_buffer();
				TTCN_Logger.log_event_str(" matched");
		...
		public void encode_text(final Text_Buf text_buf) {
			...
			case COMPLEMENTED_LIST:
				...
				break;
			default:
				throw new TtcnError("Text encoder: Encoding an uninitialized/unsupported template of type @IPL4asp_Types.Option.alpn_list.");
			}
		}
		...
		public void decode_text(final Text_Buf text_buf) {
			...
			case SPECIFIC_VALUE: {
				final int temp = text_buf.pull_int().getInt();
				if (temp < 0) {
					throw new TtcnError("Text decoder: Negative size was received for a template of type @IPL4asp_Types.Option.alpn_list.");
				}
			...
			case COMPLEMENTED_LIST: {
				final int size = text_buf.pull_int().getInt();
				list_value = new ArrayList<Option_alpn__list_template>(size);
				for (int i = 0; i < size; i++) {
					final Option_alpn__list_template temp2 = new Option_alpn__list_template();
					temp2.decode_text(text_buf);
					list_value.add(temp2);
				}
				break;
			...
			default:
				throw new TtcnError("Text decoder: An unknown/unsupported selection was received for a template of type @IPL4asp_Types.Option.alpn_list.");
			}
		}
...
default:
param.type_error("record of template", "@IPL4asp_Types.Option.alpn_list");
}
is_ifPresent = param.get_ifpresent();
set_length_range(param);
}
	...
	public void check_restriction(final template_res restriction, final String name, final boolean legacy) {
		...
		case TR_VALUE:
			...
			for (int i=0; i<value_elements.size(); i++) {
				value_elements.get(i).check_restriction(restriction, name == null ? "@IPL4asp_Types.Option.alpn_list" : name, false);
			}
			return;
		case TR_PRESENT:
			if (!match_omit(legacy)) {
		...
		throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.Option.alpn_list" : name));
	}
}
...
// originally operator<
public boolean isLessThan(final MTU__discover.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type MTU__discover. ");
return enum_value.enum_num < otherValue.enum_num;
}

// originally operator<
public boolean isLessThan(final MTU__discover otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type MTU__discover. ");
...
// originally operator<=
public boolean isLessThanOrEqual(final MTU__discover.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type MTU__discover. ");
return enum_value.enum_num <= otherValue.enum_num;
}

// originally operator<=
public boolean isLessThanOrEqual(final MTU__discover otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type MTU__discover. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type MTU__discover. ");
return  enum_value.enum_num <= otherValue.enum_value.enum_num ;
}
...
// originally operator>
public boolean isGreaterThan(final MTU__discover.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type MTU__discover. ");
return enum_value.enum_num > otherValue.enum_num;
}

// originally operator>
public boolean isGreaterThan(final MTU__discover otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type MTU__discover. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type MTU__discover. ");
return  enum_value.enum_num > otherValue.enum_value.enum_num ;
}
...
// originally operator>=
public boolean isGreaterThanOrEqual(final MTU__discover.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type MTU__discover. ");
return enum_value.enum_num >= otherValue.enum_num;
}

// originally operator>=
public boolean isGreaterThanOrEqual(final MTU__discover otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type MTU__discover. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type MTU__discover. ");
return  enum_value.enum_num >= otherValue.enum_value.enum_num ;
}
...
break;
default:
throw new TtcnError("Copying an uninitialized/unsupported template of enumerated type MTU__discover.");
}
}
...
super(template_sel.SPECIFIC_VALUE);
if (!MTU__discover.isValidEnum(otherValue)) {
throw new TtcnError("Initializing a template of enumerated type MTU__discover with unknown numeric value "+ otherValue +".");
}
...
super(template_sel.SPECIFIC_VALUE);
otherValue.must_bound("Creating a template from an unbound value of enumerated type MTU__discover. ");
single_value = otherValue.enum_value;
}
...
if (!MTU__discover.isValidEnum(otherValue)) {
throw new TtcnError("Assigning unknown numeric value " + otherValue + " to a template of enumerated type MTU__discover.");
}
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
return this;
...
otherValue.must_bound("Assignment of an unbound value of enumerated type MTU__discover to a template. ");
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
single_value = otherValue.enum_value;
return this;
...
throw new TtcnError(MessageFormat.format("Internal Error: value `MTU__discover'_template can not be cast to {1}", otherValue));
}
...
return template_selection == template_sel.COMPLEMENTED_LIST;
default:
throw new TtcnError("Matching with an uninitialized/unsupported template of enumerated type MTU__discover.");
}
}
...
if (template_selection != template_sel.SPECIFIC_VALUE || is_ifPresent) {
throw new TtcnError("Performing a valueof or send operation on a non-specific template of enumerated type MTU__discover.");
}
...
public void set_type(final template_sel templateType, final int list_length) {
if (templateType != template_sel.VALUE_LIST && templateType != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Setting an invalid list type for a template of enumerated type MTU__discover.");
}
clean_up();
set_selection(templateType);
...
if (template_selection != template_sel.VALUE_LIST && template_selection != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Accessing a list element of a non-list template of enumerated type MTU__discover.");
}
if (list_index < 0) {
throw new TtcnError("Index underflow in a value list template of enumerated type MTU__discover.");
}
if(list_index >= value_list.size()) {
throw new TtcnError("Index overflow in a value list template of enumerated type MTU__discover.");
}
return value_list.get(list_index);
}
...
switch (template_selection) {
case SPECIFIC_VALUE:
TTCN_Logger.log_event_enum(MTU__discover.enum2str(single_value), MTU__discover.enum2int(single_value));
break;
case COMPLEMENTED_LIST:
TTCN_Logger.log_event_str("complement");
case VALUE_LIST:
...
if (!MTU__discover.isValidEnum(enum_value)) {
param.error("Invalid enumerated value for type @IPL4asp_Types.MTU_discover.");
}
operator_assign(enum_value);
break;
...
case SPECIFIC_VALUE:{
final int temp = text_buf.pull_int().getInt();
if (!MTU__discover.isValidEnum(temp)) {
throw new TtcnError(MessageFormat.format("Text decoder: Unknown numeric value {0} was received for enumerated type @IPL4asp_Types.MTU_discover.", temp));
}
...
public static class HostList extends Base_Type {
	...
	public HostList operator_concatenate(final TitanNull_Type nullValue) {
...
public static class HostList_template extends Record_Of_Template {
	...
	//originally value_list/list_value
	private List<HostList_template> list_value;
	...
	private void copy_value(final HostList other_value) {
	...
	private int get_length_for_concat(final HostList operand) {
		operand.must_bound("Operand of record of template concatenation is an unbound value.");
		return operand.valueElements.size();
	}
	...
	private int get_length_for_concat(final template_sel operand) {
		...
		throw new TtcnError("Operand of record of template concatenation is an uninitialized or unsupported template.");
			...
			//TODO: simplify, just use value_elements.add()
	private void concat(final AtomicInteger pos, final HostList_template operand) {
		// all errors should have already been caught by the operand's
		// get_length_for_concat() call;
		// the result template (this) should already be set to SPECIFIC_VALUE and
		// single_value.value_elements should already be allocated
	...
	private boolean matchv(final HostList other_value, final boolean legacy) {
		if (!other_value.is_bound()) {
			return false;
		}
		final int value_length = other_value.size_of().getInt();
		...
		case COMPLEMENTED_LIST:
			...
			return template_selection == template_sel.COMPLEMENTED_LIST;
		default:
			throw new TtcnError("Matching with an uninitialized/unsupported template of type HostList.");
		}
	}
...
set_length_range(param);
	...
	public static class ASP__ConnId__ReadyToRelease extends Base_Type {
		...
		public boolean operator_equals( final ASP__ConnId__ReadyToRelease otherValue) {
			if ( !this.connId.operator_equals( otherValue.connId ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof ASP__ConnId__ReadyToRelease ) {
				return operator_equals((ASP__ConnId__ReadyToRelease) otherValue);
			}
...
public static class OptionList extends Base_Type {
	...
	private List<Option> valueElements;
	...
	public OptionList operator_concatenate(final TitanNull_Type nullValue) {
...
public static class OptionList_template extends Record_Of_Template {
	...
	//originally single_value/value_elements
	private List<Option_template> value_elements;

	//originally value_list/list_value
	private List<OptionList_template> list_value;
	...
	private void copy_value(final OptionList other_value) {
	...
	private int get_length_for_concat(final OptionList operand) {
		operand.must_bound("Operand of record of template concatenation is an unbound value.");
		return operand.valueElements.size();
	}
	...
	private int get_length_for_concat(final template_sel operand) {
		...
		throw new TtcnError("Operand of record of template concatenation is an uninitialized or unsupported template.");
			...
			//TODO: simplify, just use value_elements.add()
	private void concat(final AtomicInteger pos, final OptionList_template operand) {
		// all errors should have already been caught by the operand's
		// get_length_for_concat() call;
		// the result template (this) should already be set to SPECIFIC_VALUE and
		// single_value.value_elements should already be allocated
		...
		case SPECIFIC_VALUE:
			for (int i = 0; i < operand.value_elements.size(); ++i) {
				value_elements.set( pos.get() + i, new Option_template(operand.value_elements.get(i)) );
			}
			pos.addAndGet( operand.value_elements.size() );
			break;
		case ANY_VALUE:
		case ANY_OR_OMIT:
			...
			case NO_LENGTH_RESTRICTION:
				// ? => { * }
				value_elements.set( pos.get(), new Option_template( template_sel.ANY_OR_OMIT ) );
				pos.incrementAndGet();
				break;
			case RANGE_LENGTH_RESTRICTION:
			case SINGLE_LENGTH_RESTRICTION: {
				...
				final int N = operand.length_restriction_type == length_restriction_type_t.SINGLE_LENGTH_RESTRICTION ? operand.single_length : operand.range_length_min_length;
				for (int i = 0; i < N; ++i) {
					value_elements.set( pos.get() + i, new Option_template( template_sel.ANY_VALUE ) );
				}
				pos.addAndGet( N );
				break; }
			}
	...
	private boolean matchv(final OptionList other_value, final boolean legacy) {
		if (!other_value.is_bound()) {
			return false;
		}
		final int value_length = other_value.size_of().getInt();
		...
		case COMPLEMENTED_LIST:
			...
			return template_selection == template_sel.COMPLEMENTED_LIST;
		default:
			throw new TtcnError("Matching with an uninitialized/unsupported template of type OptionList.");
		}
	}
...
// originally operator<
public boolean isLessThan(final IPL4__Param.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__Param. ");
return enum_value.enum_num < otherValue.enum_num;
}

// originally operator<
public boolean isLessThan(final IPL4__Param otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__Param. ");
...
// originally operator<=
public boolean isLessThanOrEqual(final IPL4__Param.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__Param. ");
return enum_value.enum_num <= otherValue.enum_num;
}

// originally operator<=
public boolean isLessThanOrEqual(final IPL4__Param otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__Param. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__Param. ");
return  enum_value.enum_num <= otherValue.enum_value.enum_num ;
}
...
// originally operator>
public boolean isGreaterThan(final IPL4__Param.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__Param. ");
return enum_value.enum_num > otherValue.enum_num;
}

// originally operator>
public boolean isGreaterThan(final IPL4__Param otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__Param. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__Param. ");
return  enum_value.enum_num > otherValue.enum_value.enum_num ;
}
...
// originally operator>=
public boolean isGreaterThanOrEqual(final IPL4__Param.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__Param. ");
return enum_value.enum_num >= otherValue.enum_num;
}

// originally operator>=
public boolean isGreaterThanOrEqual(final IPL4__Param otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type IPL4__Param. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type IPL4__Param. ");
return  enum_value.enum_num >= otherValue.enum_value.enum_num ;
}
...
break;
default:
throw new TtcnError("Copying an uninitialized/unsupported template of enumerated type IPL4__Param.");
}
}
...
super(template_sel.SPECIFIC_VALUE);
if (!IPL4__Param.isValidEnum(otherValue)) {
throw new TtcnError("Initializing a template of enumerated type IPL4__Param with unknown numeric value "+ otherValue +".");
}
...
super(template_sel.SPECIFIC_VALUE);
otherValue.must_bound("Creating a template from an unbound value of enumerated type IPL4__Param. ");
single_value = otherValue.enum_value;
}
...
if (!IPL4__Param.isValidEnum(otherValue)) {
throw new TtcnError("Assigning unknown numeric value " + otherValue + " to a template of enumerated type IPL4__Param.");
}
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
return this;
...
otherValue.must_bound("Assignment of an unbound value of enumerated type IPL4__Param to a template. ");
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
single_value = otherValue.enum_value;
return this;
...
throw new TtcnError(MessageFormat.format("Internal Error: value `IPL4__Param'_template can not be cast to {1}", otherValue));
}
...
return template_selection == template_sel.COMPLEMENTED_LIST;
default:
throw new TtcnError("Matching with an uninitialized/unsupported template of enumerated type IPL4__Param.");
}
}
...
if (template_selection != template_sel.SPECIFIC_VALUE || is_ifPresent) {
throw new TtcnError("Performing a valueof or send operation on a non-specific template of enumerated type IPL4__Param.");
}
...
public void set_type(final template_sel templateType, final int list_length) {
if (templateType != template_sel.VALUE_LIST && templateType != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Setting an invalid list type for a template of enumerated type IPL4__Param.");
}
clean_up();
set_selection(templateType);
...
if (template_selection != template_sel.VALUE_LIST && template_selection != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Accessing a list element of a non-list template of enumerated type IPL4__Param.");
}
if (list_index < 0) {
throw new TtcnError("Index underflow in a value list template of enumerated type IPL4__Param.");
}
if(list_index >= value_list.size()) {
throw new TtcnError("Index overflow in a value list template of enumerated type IPL4__Param.");
}
return value_list.get(list_index);
}
...
switch (template_selection) {
case SPECIFIC_VALUE:
TTCN_Logger.log_event_enum(IPL4__Param.enum2str(single_value), IPL4__Param.enum2int(single_value));
break;
case COMPLEMENTED_LIST:
TTCN_Logger.log_event_str("complement");
case VALUE_LIST:
...
if (!IPL4__Param.isValidEnum(enum_value)) {
param.error("Invalid enumerated value for type @IPL4asp_Types.IPL4_Param.");
}
operator_assign(enum_value);
break;
...
case SPECIFIC_VALUE:{
final int temp = text_buf.pull_int().getInt();
if (!IPL4__Param.isValidEnum(temp)) {
throw new TtcnError(MessageFormat.format("Text decoder: Unknown numeric value {0} was received for enumerated type @IPL4asp_Types.IPL4_Param.", temp));
}
...
// originally operator<
public boolean isLessThan(final UDP__ENCAP__Param.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
return enum_value.enum_num < otherValue.enum_num;
}

// originally operator<
public boolean isLessThan(final UDP__ENCAP__Param otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
...
// originally operator<=
public boolean isLessThanOrEqual(final UDP__ENCAP__Param.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
return enum_value.enum_num <= otherValue.enum_num;
}

// originally operator<=
public boolean isLessThanOrEqual(final UDP__ENCAP__Param otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
return  enum_value.enum_num <= otherValue.enum_value.enum_num ;
}
...
// originally operator>
public boolean isGreaterThan(final UDP__ENCAP__Param.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
return enum_value.enum_num > otherValue.enum_num;
}

// originally operator>
public boolean isGreaterThan(final UDP__ENCAP__Param otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
return  enum_value.enum_num > otherValue.enum_value.enum_num ;
}
...
// originally operator>=
public boolean isGreaterThanOrEqual(final UDP__ENCAP__Param.enum_type otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
return enum_value.enum_num >= otherValue.enum_num;
}

// originally operator>=
public boolean isGreaterThanOrEqual(final UDP__ENCAP__Param otherValue){
must_bound("The left operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
otherValue.must_bound("The right operand of comparison is an unbound value of enumerated type UDP__ENCAP__Param. ");
return  enum_value.enum_num >= otherValue.enum_value.enum_num ;
}
...
break;
default:
throw new TtcnError("Copying an uninitialized/unsupported template of enumerated type UDP__ENCAP__Param.");
}
}
...
super(template_sel.SPECIFIC_VALUE);
if (!UDP__ENCAP__Param.isValidEnum(otherValue)) {
throw new TtcnError("Initializing a template of enumerated type UDP__ENCAP__Param with unknown numeric value "+ otherValue +".");
}
...
super(template_sel.SPECIFIC_VALUE);
otherValue.must_bound("Creating a template from an unbound value of enumerated type UDP__ENCAP__Param. ");
single_value = otherValue.enum_value;
}
...
if (!UDP__ENCAP__Param.isValidEnum(otherValue)) {
throw new TtcnError("Assigning unknown numeric value " + otherValue + " to a template of enumerated type UDP__ENCAP__Param.");
}
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
return this;
...
otherValue.must_bound("Assignment of an unbound value of enumerated type UDP__ENCAP__Param to a template. ");
clean_up();
set_selection(template_sel.SPECIFIC_VALUE);
single_value = otherValue.enum_value;
return this;
...
throw new TtcnError(MessageFormat.format("Internal Error: value `UDP__ENCAP__Param'_template can not be cast to {1}", otherValue));
}
...
return template_selection == template_sel.COMPLEMENTED_LIST;
default:
throw new TtcnError("Matching with an uninitialized/unsupported template of enumerated type UDP__ENCAP__Param.");
}
}
...
if (template_selection != template_sel.SPECIFIC_VALUE || is_ifPresent) {
throw new TtcnError("Performing a valueof or send operation on a non-specific template of enumerated type UDP__ENCAP__Param.");
}
...
public void set_type(final template_sel templateType, final int list_length) {
if (templateType != template_sel.VALUE_LIST && templateType != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Setting an invalid list type for a template of enumerated type UDP__ENCAP__Param.");
}
clean_up();
set_selection(templateType);
...
if (template_selection != template_sel.VALUE_LIST && template_selection != template_sel.COMPLEMENTED_LIST) {
throw new TtcnError("Accessing a list element of a non-list template of enumerated type UDP__ENCAP__Param.");
}
if (list_index < 0) {
throw new TtcnError("Index underflow in a value list template of enumerated type UDP__ENCAP__Param.");
}
if(list_index >= value_list.size()) {
throw new TtcnError("Index overflow in a value list template of enumerated type UDP__ENCAP__Param.");
}
return value_list.get(list_index);
}
...
switch (template_selection) {
case SPECIFIC_VALUE:
TTCN_Logger.log_event_enum(UDP__ENCAP__Param.enum2str(single_value), UDP__ENCAP__Param.enum2int(single_value));
break;
case COMPLEMENTED_LIST:
TTCN_Logger.log_event_str("complement");
case VALUE_LIST:
...
if (!UDP__ENCAP__Param.isValidEnum(enum_value)) {
param.error("Invalid enumerated value for type @IPL4asp_Types.UDP_ENCAP_Param.");
}
operator_assign(enum_value);
break;
...
case SPECIFIC_VALUE:{
final int temp = text_buf.pull_int().getInt();
if (!UDP__ENCAP__Param.isValidEnum(temp)) {
throw new TtcnError(MessageFormat.format("Text decoder: Unknown numeric value {0} was received for enumerated type @IPL4asp_Types.UDP_ENCAP_Param.", temp));
}
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.UDP_ENCAP_Param" : name));
	...
	public static class ASP__Send extends Base_Type {
		...
		public boolean operator_equals( final ASP__Send otherValue) {
			if ( !this.connId.operator_equals( otherValue.connId ) ) { return false; }
			if ( !this.proto.operator_equals( otherValue.proto ) ) { return false; }
			if ( !this.msg.operator_equals( otherValue.msg ) ) { return false; }
			return true;
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof ASP__Send ) {
				return operator_equals((ASP__Send) otherValue);
			}
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.ASP_Send" : name));
	...
	public static class Linger__opt extends Base_Type {
		...
		@Override
		public boolean is_bound() {
			if ( l__onoff.is_bound() ) { return true; }
			if ( l__linger.is_bound() ) { return true; }
			return false;
		}
		...
		@Override
		public boolean is_value() {
			if ( !l__onoff.is_value() ) { return false; }
			if ( !l__linger.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final Linger__opt otherValue) {
			if ( !this.l__onoff.operator_equals( otherValue.l__onoff ) ) { return false; }
			if ( !this.l__linger.operator_equals( otherValue.l__linger ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof Linger__opt ) {
				return operator_equals((Linger__opt) otherValue);
			}
...
@Override
		...
		public boolean is_value() {
			...
			if (!l__onoff.is_value()) {
				return false;
			}
			if (!l__linger.is_value()) {
				return false;
			}
			return true;
		}
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				l__onoff.operator_assign(template_sel.ANY_VALUE);
				l__linger.operator_assign(template_sel.ANY_VALUE);
			}
		}
	}
...
private void copy_value(final Option otherValue) {
switch (otherValue.union_selection){
case ALT_reuseAddress:
field = new ReuseAddress((ReuseAddress)otherValue.field);
break;
case ALT_tcpKeepAlive:
field = new TcpKeepAlive((TcpKeepAlive)otherValue.field);
break;
case ALT_sctpEventHandle:
field = new SctpEventHandle((SctpEventHandle)otherValue.field);
break;
case ALT_sslKeepAlive:
field = new TcpKeepAlive((TcpKeepAlive)otherValue.field);
break;
case ALT_sctpAdditionalLocalAddresses:
field = new HostList((HostList)otherValue.field);
break;
case ALT_sctpEINConfigGroup:
field = new TitanInteger((TitanInteger)otherValue.field);
break;
case ALT_solinger:
field = new Linger__opt((Linger__opt)otherValue.field);
break;
case ALT_ssl__support:
field = new SSL__proto__support((SSL__proto__support)otherValue.field);
break;
case ALT_no__delay:
field = new TitanBoolean((TitanBoolean)otherValue.field);
break;
...
field = new SSL__cert__options((SSL__cert__options)otherValue.field);
break;
case ALT_freebind:
field = new TitanBoolean((TitanBoolean)otherValue.field);
break;
case ALT_alpn__list:
field = new Option_alpn__list((Option_alpn__list)otherValue.field);
break;
case ALT_tls__hostname:
field = new TitanCharString((TitanCharString)otherValue.field);
break;
case ALT_udp__encap:
field = new UDP__ENCAP__Param((UDP__ENCAP__Param)otherValue.field);
break;
case ALT_dscp:
field = new TitanInteger((TitanInteger)otherValue.field);
break;
case ALT_mtu__discover:
field = new MTU__discover((MTU__discover)otherValue.field);
break;
case ALT_psk__options:
field = new PSK__options((PSK__options)otherValue.field);
break;
default:
...
if (list_index < 0) {
throw new TtcnError("Internal error: Index underflow in a value list template of union type @IPL4asp_Types.Option.");
}
if(list_index >= value_list.size()) {
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.Option" : name));
	...
	public static class PSK__options extends Base_Type {
		...
		@Override
		public boolean is_bound() {
			if ( optional_sel.OPTIONAL_OMIT.equals(psk__identity.get_selection()) || psk__identity.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(psk__identity__hint.get_selection()) || psk__identity__hint.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(psk__key.get_selection()) || psk__key.is_bound() ) { return true; }
			return false;
		}
		...
		@Override
		public boolean is_value() {
			if ( !optional_sel.OPTIONAL_OMIT.equals(psk__identity.get_selection()) && !psk__identity.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(psk__identity__hint.get_selection()) && !psk__identity__hint.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(psk__key.get_selection()) && !psk__key.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final PSK__options otherValue) {
			if ( !this.psk__identity.operator_equals( otherValue.psk__identity ) ) { return false; }
			if ( !this.psk__identity__hint.operator_equals( otherValue.psk__identity__hint ) ) { return false; }
			if ( !this.psk__key.operator_equals( otherValue.psk__key ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof PSK__options ) {
				return operator_equals((PSK__options) otherValue);
			}
...
@Override
		...
		public boolean is_bound() {
			...
			if (psk__identity.is_omit() || psk__identity.is_bound()) {
				return true;
			}
			if (psk__identity__hint.is_omit() || psk__identity__hint.is_bound()) {
				return true;
			}
			if (psk__key.is_omit() || psk__key.is_bound()) {
				return true;
			}
			return false;
		}
...
@Override
		...
		public boolean is_value() {
			...
			if (!psk__identity.is_omit() && !psk__identity.is_value()) {
				return false;
			}
			if (!psk__identity__hint.is_omit() && !psk__identity__hint.is_value()) {
				return false;
			}
			if (!psk__key.is_omit() && !psk__key.is_value()) {
				return false;
			}
			return true;
		}
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				psk__identity.operator_assign(template_sel.ANY_OR_OMIT);
				psk__identity__hint.operator_assign(template_sel.ANY_OR_OMIT);
				psk__key.operator_assign(template_sel.ANY_OR_OMIT);
			}
		}
	}
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.PSK_options" : name));
	...
	public static class IPL4__SrtpKeysAndSalts extends Base_Type {
		...
		@Override
		public boolean is_bound() {
			if ( localKey.is_bound() ) { return true; }
			if ( remoteKey.is_bound() ) { return true; }
			if ( localSalt.is_bound() ) { return true; }
			if ( remoteSalt.is_bound() ) { return true; }
			return false;
		}
		...
		@Override
		public boolean is_value() {
			if ( !localKey.is_value() ) { return false; }
			if ( !remoteKey.is_value() ) { return false; }
			if ( !localSalt.is_value() ) { return false; }
			if ( !remoteSalt.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final IPL4__SrtpKeysAndSalts otherValue) {
			if ( !this.localKey.operator_equals( otherValue.localKey ) ) { return false; }
			if ( !this.remoteKey.operator_equals( otherValue.remoteKey ) ) { return false; }
			if ( !this.localSalt.operator_equals( otherValue.localSalt ) ) { return false; }
			if ( !this.remoteSalt.operator_equals( otherValue.remoteSalt ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof IPL4__SrtpKeysAndSalts ) {
				return operator_equals((IPL4__SrtpKeysAndSalts) otherValue);
			}
...
@Override
		...
		public boolean is_value() {
			...
			if (!localKey.is_value()) {
				return false;
			}
			if (!remoteKey.is_value()) {
				return false;
			}
			if (!localSalt.is_value()) {
				return false;
			}
			if (!remoteSalt.is_value()) {
				return false;
			}
			return true;
		}
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				localKey.operator_assign(template_sel.ANY_VALUE);
				remoteKey.operator_assign(template_sel.ANY_VALUE);
				localSalt.operator_assign(template_sel.ANY_VALUE);
				remoteSalt.operator_assign(template_sel.ANY_VALUE);
			}
		}
	}
...
if (list_index < 0) {
throw new TtcnError("Internal error: Index underflow in a value list template of union type @IPL4asp_Types.anytype.");
}
if(list_index >= value_list.size()) {
...
throw new TtcnError(MessageFormat.format("Restriction `{0}'' on template of type {1} violated.", get_res_name(restriction), name == null ? "@IPL4asp_Types.anytype" : name));
	...
	public static class TcpKeepAlive extends Base_Type {
		...
		public boolean is_bound() {
			if ( optional_sel.OPTIONAL_OMIT.equals(enable.get_selection()) || enable.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(count.get_selection()) || count.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(idle.get_selection()) || idle.is_bound() ) { return true; }
			if ( optional_sel.OPTIONAL_OMIT.equals(interval.get_selection()) || interval.is_bound() ) { return true; }
			return false;
		}
		...
		public boolean is_value() {
			if ( !optional_sel.OPTIONAL_OMIT.equals(enable.get_selection()) && !enable.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(count.get_selection()) && !count.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(idle.get_selection()) && !idle.is_value() ) { return false; }
			if ( !optional_sel.OPTIONAL_OMIT.equals(interval.get_selection()) && !interval.is_value() ) { return false; }
			return true;
		}


		public boolean operator_equals( final TcpKeepAlive otherValue) {
			if ( !this.enable.operator_equals( otherValue.enable ) ) { return false; }
			if ( !this.count.operator_equals( otherValue.count ) ) { return false; }
			if ( !this.idle.operator_equals( otherValue.idle ) ) { return false; }
			if ( !this.interval.operator_equals( otherValue.interval ) ) { return false; }
			return true;
		}
		...
		public boolean operator_equals(final Base_Type otherValue) {
			if (otherValue instanceof TcpKeepAlive ) {
				return operator_equals((TcpKeepAlive) otherValue);
			}
...
@Override
		...
		public boolean is_bound() {
			...
			if (count.is_omit() || count.is_bound()) {
				return true;
			}
			if (idle.is_omit() || idle.is_bound()) {
				return true;
			}
			if (interval.is_omit() || interval.is_bound()) {
				return true;
			}
			return false;
		}
...
@Override
		...
		public boolean is_value() {
			...
			if (!count.is_omit() && !count.is_value()) {
				return false;
			}
			if (!idle.is_omit() && !idle.is_value()) {
				return false;
			}
			if (!interval.is_omit() && !interval.is_value()) {
				return false;
			}
			return true;
		}
	...
	private void set_specific() {
		if (template_selection != template_sel.SPECIFIC_VALUE) {
			...
			if (old_selection == template_sel.ANY_VALUE || old_selection == template_sel.ANY_OR_OMIT) {
				enable.operator_assign(template_sel.ANY_OR_OMIT);
				count.operator_assign(template_sel.ANY_OR_OMIT);
				idle.operator_assign(template_sel.ANY_OR_OMIT);
				interval.operator_assign(template_sel.ANY_OR_OMIT);
			}
		}
	}
